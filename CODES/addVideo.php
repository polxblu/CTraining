...
if(empty($_POST['difficultN'])||empty($_POST['name'])||empty($_POST['categoryN'])||empty($_POST['muscleGroupN'])){
    ...
    $dataDB->setColDt(array('id','name','muscleGroup','difficult','free','category'));
    $dataDB->setValDt(array($var['newID'],txaTOdb($_POST['name'],true),$_POST['muscleGroupN'],$_POST['difficultN'],$var['yn'],$_POST['categoryN']));
    $dataDB->insert('video');
