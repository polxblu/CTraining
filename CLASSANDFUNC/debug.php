...
';
if (isset($_GET['token']))echo '&nbsp;Token&nbsp;<font color="#ff0000">&nbsp;<=> '.$_GET['token'].'<br></font>';
echo'<table cellpadding="5" cellspacing="5px"><tr><td valign="top" align="left" style="border-right:1px black solid;">Variabili<br>';
foreach($var as $key => $value){
    if($key!=='redi'){if(!is_array($value)){
        echo '<font color="#ff0000"> '.$key.' <=> '.$value.'<br></font>';
}}}
echo '</td><td valign="top" align="left" style="border-right:1px black solid;">GET<br>';
